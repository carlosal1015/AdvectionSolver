...
/*This script can create a custom discrete distribution from a given interval and given function.
More complex distributions may require if else cases to switch between different generation functions in function().
*/
